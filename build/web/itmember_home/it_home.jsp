...
<%
    ...
    String sql="select * from (select * from news order by timestamp desc) ref where timestamp<"+gl_id+" and rownum<=3";
   // String sql="select * from (select * from news) news where timestamp<"+gl_id+" and rownum<=3";
    dn.connect(sql);
...
<div class="container" style="width:100%;height:350px;background-color: whitesmoke;margin-top: 20px;border-radius:5px; ">
                    <div class="row" style="margin-top: 10px">
                        ...
                        <div style="font-family: sans-serif;" class="text-capitalize">
                            ...
                            <div>
                                <small><span><b>short </b></span><span class="text-info">by <%=newss.get(i).getAuthor_id() %> || <%=newss.get(i).getPublish_date() %></span></small>
                            </div>
